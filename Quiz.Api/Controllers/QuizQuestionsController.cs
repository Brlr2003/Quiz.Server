...
namespace Quiz.Api.Controllers
{
    ...
    public class QuizQuestionsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<QuizQuestion>> GetQuizQuestion(long id)
        {
          if (_context.QuizQuestions == null)
          {
              return NotFound();
        ...
        public async Task<ActionResult<QuizQuestion>> PostQuizQuestion(QuizQuestion quizQuestion)
        {
          if (_context.QuizQuestions == null)
          {
              return Problem("Entity set 'QuizContext.QuizQuestions'  is null.");
          }
            _context.QuizQuestions.Add(quizQuestion);
            await _context.SaveChangesAsync();

            return CreatedAtAction(nameof(GetQuizQuestion), new { id = quizQuestion.Id }, quizQuestion);
        }
        ...
        private bool QuizQuestionExists(long id)
        {
